...
ggsave("plots/heart_meanvariance.png", width = 18, height = 10, units = "cm", scale = 0.8)
...
# saving data
write.table(
    variableProbes$mouse, file = "data/heart_quantNormData_mouse_1sd.tsv",
    sep = "\t", col.names = TRUE, row.names = FALSE, quote = FALSE
)
write.table(
    variableProbes$rat, file = "data/heart_quantNormData_rat_1sd.tsv",
    sep = "\t", col.names = TRUE, row.names = FALSE, quote = FALSE
)
...
write.table(variable_gene$mouse, file = "data/gl_heart_variable_gene_mouse.txt", quote = FALSE, col.names = FALSE, row.names = FALSE)
write.table(variable_gene$rat, file = "data/gl_heart_variable_gene_rat.txt", quote = FALSE, col.names = FALSE, row.names = FALSE)
