...
# $mouse
# [1]  568   36  669 1824   31 4240    3
#
# $rat
# [1]   1  20 540   4   1 344   7
...
xlabs <- vector()
xlabs[1] <- expression(atop(bold(1), scriptstyle("(1)"  )))
xlabs[2] <- expression(atop(bold(2), scriptstyle("(20)" )))
xlabs[3] <- expression(atop(bold(3), scriptstyle("(540)")))
xlabs[4] <- expression(atop(bold(4), scriptstyle("(4)" )))
xlabs[5] <- expression(atop(bold(5), scriptstyle("(1)"  )))
xlabs[6] <- expression(atop(bold(6), scriptstyle("(344)"  )))
xlabs[7] <- expression(atop(bold(7), scriptstyle("(7)"   )))

map_int(myGeneClusters$mouse, length)
ylabs <- vector()
ylabs[1] <- expression(paste(scriptstyle("(568)"  ), bold(1)))
ylabs[2] <- expression(paste(scriptstyle("(36)"), bold(2)))
ylabs[3] <- expression(paste(scriptstyle("(669)" ), bold(3)))
ylabs[4] <- expression(paste(scriptstyle("(1824)"  ), bold(4)))
ylabs[5] <- expression(paste(scriptstyle("(31)" ), bold(5)))
ylabs[6] <- expression(paste(scriptstyle("(4240)"), bold(6)))
ylabs[7] <- expression(paste(scriptstyle("(3)"   ), bold(7)))
...
ggsave("plots/fig2X_heart_hclust_homology.svg", myPlot, device = svglite, width = 6, height = 4, units = "cm", scale = 1.8)
